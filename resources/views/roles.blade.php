                                        ...
                                        <table class="table table-striped table-hover" id="datatable2" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('role.edit',$item->id)}}"><i class="fa fa-edit" style="color: green;font-size: 18px;padding-right: 10px;"></i></a>
                                                        <a href="{{route('role.delete',$item->id)}}"><i class="fa fa-trash" style="color:orangered;font-size: 18px;"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
