                                        ...
                                        <table class="table table-striped table-hover" id="datatable2" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('role.edit',$item->id)); ?>"><i class="fa fa-edit" style="color: green;font-size: 18px;padding-right: 10px;"></i></a>
                                                        <a href="<?php echo e(route('role.delete',$item->id)); ?>"><i class="fa fa-trash" style="color:orangered;font-size: 18px;"></i></a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HourLog\resources\views/roles.blade.php ENDPATH**/ ?>