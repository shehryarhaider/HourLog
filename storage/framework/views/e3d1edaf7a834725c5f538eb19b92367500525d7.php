                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="admin-form theme-primary">
                                        ...
                                        <div class="panel">
                                            ...
                                            <form method="post" action="<?php echo e($isEdit ?  route('phase.update',$find_phase->id): route('phase.store')); ?>" id="admin-form">
                                                <?php echo csrf_field(); ?>
                                                <div class="panel-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <label for="name" class="field prepend-icon">
                                                                <input type="text" name="name" id="name"
                                                                    class="gui-input" placeholder="Name ..." required value="<?php echo e($isEdit ? $find_phase->name : old('name')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HourLog\resources\views/add-phase.blade.php ENDPATH**/ ?>