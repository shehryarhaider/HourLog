                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading" style="height: 60px;padding: 7px;">
                                <span class="panel-title" style="font-size: 25px;">Client</span>
                                <div class="widget-menu pull-right">
                                    <a href="<?php echo e(route('client.create')); ?>">
                                        <div class="col-md-12">
                                            <button type="button"
                                                class="btn btn-primary btn-gradient dark btn-block">Add Client</button>
                                        </div>
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-striped table-hover" id="datatable2" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('client.edit',$item->id)); ?>"><i class="fa fa-edit" style="color: green;font-size: 18px;padding-right: 10px;"></i></a>
                                                        <a href="<?php echo e(route('client.delete',$item->id)); ?>"><i class="fa fa-trash" style="color:orangered;font-size: 18px;"></i></a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HourLog\resources\views/client.blade.php ENDPATH**/ ?>