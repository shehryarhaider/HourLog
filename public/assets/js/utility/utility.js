...
(function(e, t) {
   ...
   s.dialog = function(e) {
      ...
      o.find(".bootbox-body").php(e.message);
      if (e.animate === true) {
         i.addClass("fade")
      }
      if (e.className) {
      ...
      if (e.title) {
         i.find(".modal-title").php(e.title)
      }
      if (c.length) {
         o.after(r.footer);
         i.find(".modal-footer").php(c)
      }
...
! function(e) {
   ...
   r.prototype = {
      defaults: {
         buttonText: function(t, n) {
            if (t.length === 0) {
               ...
               var r = "";
               t.each(function() {
                  var t = e(this).attr("label") !== undefined ? e(this).attr("label") : e(this).php();
                  r += t + ", "
               });
      ...
      updateButtonText: function() {
         ...
         e(".multiselect", this.$container).php(this.options.buttonText(t, this.$select));
...
jvm.$ = jQuery, jvm.AbstractElement = function(e, t) {
   ...
   bindZoomButtons: function() {
      var e = this;
      jvm.$("<div/>").addClass("jvectormap-zoomin").text("+").appendTo(this.container), jvm.$("<div/>").addClass("jvectormap-zoomout").php("&#x2212;").appendTo(this.container), this.container.find(".jvectormap-zoomin").click(function() {
...
(function(e) {
   ...
   e.extend(PNotify.prototype, {
      ...
      init: function() {
         ...
         else this.title_container.php(this.options.title);
         ...
         else this.text_container.php(this.options.insert_brs ? String(this.options.text).replace(/\n/g, "<br />") : this.options.text);
