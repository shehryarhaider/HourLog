 ...
 * ref: http://www.unicode.org/reports/tr35/tr35-dates.php#Date_Format_Patterns
 *
 * @cldr [Cldr instance].
 *
...
return function( date, pattern, cldr ) {
	...
	return pattern.replace( datePatternRe, function( current ) {
		...
		if ( chr === "j" ) {
			...
			// http://www.unicode.org/reports/tr35/tr35-dates.php#Time_Data
		...
		switch ( chr ) {
			...
			case "E":
				...
				if ( length === 6 ) {
					...
					// used instead.
					// http://www.unicode.org/reports/tr35/tr35-dates.php#months_days_quarters_eras
			...
			// Zone
			// see http://www.unicode.org/reports/tr35/tr35-dates.php#Using_Time_Zone_Names ?
