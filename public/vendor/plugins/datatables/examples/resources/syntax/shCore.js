...
var sh = {
    ...
    highlight: function(globalParams, element)
    {
        ...
        for (var i = 0, l = elements.length; i < l; i++)
        {
            ...
            {
                highlighter = new sh.phpScript(brushName);
 ...
 */
sh.phpScript = function(scriptBrushName)
{
    ...
    xmlBrush.regexList.push(
        { regex: scriptBrush.phpScript.code, func: process }
    );
    ...
    function process(match, info)
    {
        var code = match.code,
            ...
            htmlScript = scriptBrush.phpScript,
            result
            ;
