...
/*
  ...
  Call Circles.create(options) with the following options:
    ...
    API:
      updateRadius(radius) - regenerates the circle with the given radius (see spec/responsive.php for an example hot to create a responsive circle)
...
(function() {
  ...
  Circles = window.Circles = function(options) {
    ...
    this._text           = options.text === undefined ? function(value){return this.phpifyNumber(value);} : options.text;
